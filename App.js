    ...
    <View style={styles.principal}>
      ...
      */}
        ...
        */}
          ...
          <View style={styles.btnContent}>
            ...
            <View style={styles.btnView}>
              ...
              <TouchableOpacity onPress={showDialogM}>
                <Text style={{fontSize: 30, color: 'dimgray'}}>m</Text>
              </TouchableOpacity>
            </View>
            <View style={styles.btnView}>
              {/*le boutton retirer*/}
        ...
        <View style={styles.center}>
          ...
          <View style={styles.centerBtnView1}>
              {/*le boutton ajouter*/}
              <TouchableOpacity onPress={()=> Alert.alert('Bascule a droite')}>
                <Text style={{fontSize: 30, color: 'dimgray'}}>{">>"}</Text>
              </TouchableOpacity>
            </View>
            <View style={styles.centerBtnView2}>
              {/*le boutton modifier*/}
              <TouchableOpacity onPress={()=>Alert.alert('bascule a gauche')}>
                <Text style={{fontSize: 30, color: 'dimgray'}}>{"<<"}</Text>
              </TouchableOpacity>
            </View>
      ...
      <View style={styles.footer}>
        ...
        */}
        <Text style={styles.message}>Projet SJP5 V 0.0.2</Text>
        <Text style={styles.message}>fait à Douala le 19 Novembre 2021</Text>
        <Text style={styles.message}>par Nguime christian ardy</Text>
        <Text style={styles.message}>email: anguime@univ-catho-sjd.com</Text>
